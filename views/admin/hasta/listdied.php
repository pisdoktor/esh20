<div class="container-fluid py-4">
    <div class="row align-items-center mb-4">
        <div class="col-md-4">
            <h4 class="fw-bold text-dark mb-0">
                <i class="fa-solid fa-skull me-2 small"></i><?= $pageTitle;?>
            </h4>
            <small class="text-muted">Ölen hasta kayıtları arasında arama yapın</small>
        </div>
        <div class="col-md-5">
            <form action="index.php" method="GET" class="d-flex shadow-sm rounded-pill overflow-hidden bg-white p-1">
                ...
                <input type="hidden" name="action" value="listdied">
    ...
    <?php if(!empty($search)): ?>
        <div class="alert alert-info py-2 d-flex justify-content-between align-items-center rounded-4 mb-3">
            ...
            <a href="index.php?controller=Patient&action=listdied" class="btn btn-sm btn-outline-info rounded-pill">Aramayı Temizle</a>
        </div>
    <?php endif; ?>
    ...
    <div class="d-flex flex-column">
        <div class="d-flex align-items-center mb-1">
            ...
            <a href="index.php?controller=Patient&action=listdied&search=<?= urlencode($patient->ilce_adi) ?>" 
