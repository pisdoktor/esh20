                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" maxlength="11" id="tckimlik" name="tckimlik" class="form-control" value="<?= $patient->tckimlik;?>" required placeholder="11 Haneli TC Kimlik No">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="isim" class="form-control" value="<?= $patient->isim;?>" required style="text-transform: uppercase;" placeholder="Örn: AHMET">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">Soyadı:</label>
                                    <input type="text" name="soyisim" class="form-control" value="<?= $patient->soyisim;?>" required style="text-transform: uppercase;" placeholder="Örn: YILMAZ">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="btn-group w-100" role="group">
                                    <input type="radio" class="btn-check" name="cinsiyet" id="gender-m" value="1" <?= $patient->cinsiyet == 1 ? 'selected':'';?> required>
                                    <label class="btn btn-outline-primary py-2" for="gender-m"><i class="fa-solid fa-person me-2"></i>Erkek</label>

                                    <input type="radio" class="btn-check" name="cinsiyet" id="gender-f" value="2" <?= $patient->cinsiyet == 2 ? 'selected':'';?> required>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="anneAdi" class="form-control" value="<?= $patient->anneAdi;?>" style="text-transform: uppercase;" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">Baba Adı:</label>
                                    <input type="text" name="babaAdi" class="form-control" value="<?= $patient->babaAdi;?>" style="text-transform: uppercase;" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="dogumtarihi" name="dogumtarihi" class="form-control datepicker" value="<?= $patient->dogumtarihi;?>" placeholder="GG.AA.YYYY" required readonly style="background-color: #fff;">
                                </div>
                            </div>
                            <div class="mb-0">
                                ...
                                <select name="guvence" class="form-select chosen-select">
                                    ...
                                    <?php foreach($guvence as $g): ?>
                                        <option value="<?= $g->id ?>"<?= $g->id == $patient->guvence ? 'selected':'';?>><?= $g->guvenceadi ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
...
<style>
    /* Bootstrap 5 ile Chosen Uyumu ve Özel Stiller */
    ...
    /* Datepicker BS5 Uyumu */
    .datepicker { padding: 10px !important; }
    
    /* Telefon ve TC girişi için focus efekti */
    .form-control:focus {
        border-color: #86b7fe;
